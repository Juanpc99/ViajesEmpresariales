...
@NamedNativeQueries({
	@NamedNativeQuery(name="Cliente.consultarClientesConFiltros", query = "", resultSetMapping = "consultarClientesConFiltros")
})
@SqlResultSetMappings({
	@SqlResultSetMapping(name="consultarClientesConFiltros", 
			classes= {@ConstructorResult(targetClass = ClienteDTO.class,
			columns = {
					@ColumnResult(name="nombre", type = String.class),
					@ColumnResult(name="numeroIdentificacion", type = String.class),
					@ColumnResult(name="idTiid", type = Integer.class),
...
public class Cliente {
	...
	public TipoIdentificacion idTiid;
